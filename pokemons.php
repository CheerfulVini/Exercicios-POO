...
class pokemon{
    ...
    function __construct($no, $nu, $ti, $se, $ta, $pe, $vi, $ve, $at, $de, $ni = 0, $fo = false, $af = false, $ar = false, $pm = false) {
        $this->nome = $no;
        $this->numero = $nu;
        $this->tipo = $ti;
        $this->sexo = $se;
...
$sprigatito = new pokemon("Sprigatito", 906, "Grama", "Fêmea", 0.50, 4.1, 1, 40, 65, 61, 54, true, true);
$pikachu = new pokemon("Pikachu", 25, "Elétrico", "Macho", 0.45, 6, 1, 35, 90, 55, 40, false, false, true, true);
